...
public class EmployeeMSDbContext :
    AbpDbContext<EmployeeMSDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public EmployeeMSDbContext(DbContextOptions<EmployeeMSDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(EmployeeMSConsts.DbTablePrefix + "Employees",
